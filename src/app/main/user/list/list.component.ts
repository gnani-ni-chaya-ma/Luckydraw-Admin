...
import { UserService } from 'app/main/_service/user.service';
...
export class ListComponent implements OnInit {
  ...
  user: any;
  dataSource: any;
  displayedColumns = ['username', 'contactNumber', 'points', 'questionState', 'buttons'];
  ...
  async getUsers() {
    try {
      let data = await this._userService.getUserList().toPromise();
